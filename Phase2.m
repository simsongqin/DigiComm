...
figure (3);
subplot(411); plot(sigPlot); title('Data signal'); ylim([-0.1 1.1]); xlim([0 1800]);
subplot(412); plot(modOOKplot); title('OOK modulated signal'); xlim([0 1800]);
subplot(413); plot(modBPSKplot); title('BPSK modulated signal'); xlim([0 1800]);
subplot(414); plot(modBFSKplot); title('BFSK modulated signal'); xlim([0 1800]);
...
figure (5);
subplot (311); plot(demodOOKplot); title('OOK demodulated signal'); xlim([0 1800]);
subplot (312); plot(demodBPSKplot); title('BPSK demodulated signal'); xlim([0 1800]);
subplot (313); plot(demodBFSKplot); title('BFSK demodulated signal'); xlim([0 1800]);
